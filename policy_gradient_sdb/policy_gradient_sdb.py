...
if __name__=="__main__":
    for seed in seeds:
        ...
        print(f"Hyperparameters: Policy learning rate: {lr_act} | episodes_per_epoch: {episodes_per_epoch} | seed: {seed}")
        ...
        log_df = pd.DataFrame()
        log_file_name = f'-PG_with_stb-env={env_name}-po_lr={lr_act}-crt_lr={lr_crt}-episodes_per_epoch={episodes_per_epoch}-no.hidden: {nn_hidden}-no.iteration:{epochs}-seed:{seed}.csv'
