...
colors = ['b', 'r', 'g', 'k', 'c']
runs = [['LunarLander-v2', 1e-3, 1e-3, 5, [64,64], 3000, [0,10,1234]]]
if __name__ == '__main__':
	...
	###############################  Save the figures  ########################################
	eps_len_fig.savefig('Episode length', dpi=350)
	q_estimate_fig.savefig('Q estimate', dpi=350)
	training_return_fig.savefig('Training return', dpi=350)
	mean_return_fig.savefig('Mean return', dpi=350)
	std_return_fig.savefig('Std return', dpi=350)
	max_return_fig.savefig('Max return', dpi=350)
	min_return_fig.savefig('Min return', dpi=350)
	mean_value_fig.savefig('Mean value', dpi=350)
	policy_loss_fig.savefig('Policy loss', dpi=350)
	kl_fig.savefig('KL', dpi=350)
	entropy_fig.savefig('Entropy', dpi=350)
	value_loss_fig.savefig('Value loss', dpi=350)
